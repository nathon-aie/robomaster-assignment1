...
> - `OBJECT PLACE`: ไปที่ช่องของ, หมุนตัวกวาด ToF หาของ, แล้วหนีบ
> - `DELIVERY`: เอาของที่ถืออยู่ไปวางที่จุด `P` หันตามทิศที่กำหนด
> - เครื่องมือ `Object` / `Delivery` (แถว TOOLS): ตั้งช่องของ และช่องที่จะเอาไปวาง
> - `TARGET: OBJECT` / `TARGET: DELIVERY`: หน้าต่างซูม 9×9 เลือกจุดย่อยในช่องนั้น ๆ
