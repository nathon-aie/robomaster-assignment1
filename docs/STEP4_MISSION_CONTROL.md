...
### หน้าต่างเล็งจุดวาง `TARGET` (9×9)

ช่องกริดกว้าง 60 ซม. แต่ขวดกว้างไม่กี่ ซม. — ปุ่ม `TARGET` เปิดหน้าต่างซูม
ช่อง Place ช่องเดียว แบ่งเป็น **9×9** (~6.7 ซม./ช่องย่อย บนกริด 60 ซม.)
คลิกช่องย่อยเพื่อกำหนดจุดปล่อยของจริง ๆ
